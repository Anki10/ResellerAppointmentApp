...
public class AssessmentFragment extends BaseFragment implements ListAdapterListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        image_Stores_capability = (ImageView) view.findViewById(R.id.image_Stores_capability);
        ...
        Stores_capabilit_recycler_view = (RecyclerView) view.findViewById(R.id.Stores_capabilit_recycler_view);
        ...
        if (getArrayList("Stores_capabilit_list") != null){
            if (getArrayList("Stores_capabilit_list").size() > 0){
                ...
                Stores_capabilit_adapter = new ImageShowAdapter(getActivity(),image_Stores_capabilit_list,"","image_Stores_capabilit",this);
        ...
        if (getArrayList("inventory_mngmnt") != null){
            if (getArrayList("inventory_mngmnt").size() > 0){
                ...
                inventory_mngmnt_adapter = new ImageShowAdapter(getActivity(),image_inventory_mngmnt_list,"","image_inventory_mngmnt",this);
        ...
        if (getArrayList("brand_outlet") != null){
            if (getArrayList("Quality_list").size() > 0){
                ...
                brand_outlet_adapter = new ImageShowAdapter(getActivity(),image_brand_outlet_list,"","image_brand_outlet",this);
        ...
        if (getArrayList("image_signs_labels_list") != null){
            if (getArrayList("image_signs_labels_list").size() > 0){
                ...
                signs_labels_adapter = new ImageShowAdapter(getActivity(),image_signs_labels_list,"","image_signs_labels",this);
        ...
        if (getArrayList("image_inhouse_ppe") != null){
            if (getArrayList("image_inhouse_ppe").size() > 0){
                ...
                inhouse_ppe_adapter = new ImageShowAdapter(getActivity(),image_inhouse_ppe_list,"","image_inhouse_ppe",this);
        ...
        if (getArrayList("saftey_image_3") != null){
            if (getArrayList("saftey_image_3").size() > 0){
                ...
                fire_safety_adapter = new ImageShowAdapter(getActivity(),image_fire_safety_list,"","image_fire_safety",this);
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == 1) {
                ...
                if (picUri != null){
                    ...
                    Stores_capabilit_adapter = new ImageShowAdapter(getActivity(),image_Stores_capabilit_list,"","Stores_capabilit",AssessmentFragment.this);
                    Stores_capabilit_recycler_view.setAdapter(Stores_capabilit_adapter);
                ...
                if (picUri != null){
                    ...
                    inventory_mngmnt_adapter = new ImageShowAdapter(getActivity(),image_inventory_mngmnt_list,"","inventory_mngmnt",AssessmentFragment.this);
                    inventory_mngmnt_recycler_view.setAdapter(inventory_mngmnt_adapter);
                ...
                if (picUri != null){
                    ...
                    brand_outlet_adapter = new ImageShowAdapter(getActivity(),image_brand_outlet_list,"","Quality",AssessmentFragment.this);
                    brand_outlet_recycler_view.setAdapter(brand_outlet_adapter);
                ...
                if (picUri != null){
                    ...
                    signs_labels_adapter = new ImageShowAdapter(getActivity(),image_signs_labels_list,"","signs_labels",AssessmentFragment.this);
                    signs_labels_recycler_view.setAdapter(signs_labels_adapter);
                ...
                if (picUri != null){
                    ...
                    inhouse_ppe_adapter = new ImageShowAdapter(getActivity(),image_inhouse_ppe_list,"","saftey_image_2",AssessmentFragment.this);
                    inhouse_ppe_recycler_view.setAdapter(inhouse_ppe_adapter);
                ...
                if (picUri != null){
                    ...
                    fire_safety_adapter = new ImageShowAdapter(getActivity(),image_fire_safety_list,"","saftey_image_3",AssessmentFragment.this);
                    fire_safety_recycler_view.setAdapter(fire_safety_adapter);
